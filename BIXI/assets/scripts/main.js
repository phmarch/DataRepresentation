 ...
 */
 (function (d3, localization) {
  ...
  d3.json("./data/bixi-destinations.json", function (error, data) {
    if (error) {
      throw error;
    }
    ...
    .attr("data-style", function(d, i) {
      return "left: 10px; top: 10px; position: absolute; width: 10px; height: 10px; background-color: "
      + color(d.name);
    })
    .text(function (d) {
      return d.name;
